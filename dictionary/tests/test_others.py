...
class WordsTestCase(TestCase):
    ...
    def test_get_words_should_return_list_of_tuples_sorted_by_values_which_are_words(self):
        self.words.add_word('break', 'przerwa')
    ...
    def test_save_to_db_after_saving_words_of_session_should_appear_in_the_words_of_dictionary_object(self):
        self.words.add_word('break', 'przerwa')
        self.words.add_word('attention', 'uwaga')
    ...
    def test_save_to_db_after_saving_dictionary_session_should_be_removed_from_session(self):
        self.words.add_word('break', 'przerwa')
        self.words.add_word('attention', 'uwaga')
    ...
    def test_refresh_list_should_undo_changes_by_copying_words_from_dictionary_object_to_session(self):
        self.words.add_word('love', 'miłość')
        self.words.save_to_db()
